<template>
  <section v-if="Object.keys(selectedState).length" class="relative">
    ...
    <button type="button" @click="handleClose" class="absolute top-0 right-0">
      <svg
...
export default {
  ...
  methods: {
    calculateMaxGraphElements() {
      ...
      this.$emit("calc-max-graph-elem", this.maxGraphElements);
    },
    handleClose() {
